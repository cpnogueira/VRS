...
\begin{minipage}{0.425\columnwidth}
\textbf{NDetG}\\
-Remove all stages/edges that do not satisfy acceptance condition \\
-Use Subset construction (Rabin-Scott) \\
-Acceptance condition: states where \{\} is never reached \\
-Becomes DetG \\
\end{minipage}
}
\savestack{\listingFA}{\box0}

\setbox0=\hbox{%
\begin{minipage}{0.425\columnwidth}
%\begin{lstlisting}
\textbf{NDetF (partial) or NDetPrefix} \\
-Use Breakpoint Construction \\
-Becomes DetFG \\
\\
\textbf{NDetF (total)} \\
-Use Subset Construction \\
-Acceptance condition same as before \\
-Become DetF \\
%\end{lstlisting}
\end{minipage}
}
\savestack{\listingFB}{\box0}
...
\savestack{\listingFC}{\box0}

\setbox0=\hbox{%
\begin{minipage}{0.425\columnwidth}
\textbf{NDetGF} \\
-Use Safra algorithm \\
-Become DetRabin or DetStreett \\
\end{minipage}
}
\savestack{\listingFD}{\box0}
...
\textbf{Automaton Determinization}
\begin{tabular}{|l|l|}
\hline
{\listingFA} &
{\listingFB} \\
