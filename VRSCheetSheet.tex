...
$\diamondsuit$\textit{(Points to some in the set? Yes, enter!)} \\
$\overleftarrow{\diamondsuit}$\textit{(Is pointed by some in the set? Yes, enter!)} \\
$\square$\textit{(Points to some outside the set? Yes, \underline{don't} enter!)} \\
$\overleftarrow{\square}$\textit{(Pointed by some out the set? Yes, \underline{don't} enter!)} \\
\begin{tabular}{l l}
