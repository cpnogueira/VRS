...
\textbf{LTL Model Checking}
Given LTL formula $\Phi \equiv A \varphi$, translate $\neg \varphi$ to an $\omega\text{-automaton } \Afra_{\neg \varphi} = \Ab_{\exists}(Q,\varphi_{\Ib},\varphi_{\Rb},\varphi_{\Fb})$. Thus: \\
$\Kb \vDash A \varphi \Leftrightarrow \Kb \vDash \neg E \neg \varphi \Leftrightarrow \Kb \vDash \Afra_{\neg \varphi} \Leftrightarrow \Kb \times \Kb_{\Afra} \vDash \neg E \varphi_{\Fb}$\\
Reduction to $\omega$-automaton emptiness.
...
LTL formulas that can't be translated for CTL\\
*  E[([a1 SU b1] | [a2 SU b2]) SU c]\\
*  E[(a | [b SU c]) SU d]\\
*  E[[[a SU b] SU c] SU d]\\
*  E[[a SU [b SU c]] SU d]\\
*  EG[([a1 SU b1] | [a2 SU b2]) SU c]\\
*  EG(a | X a)\\
*  EG(a | [b SU c])\\
*  EG[[a SU b] SU c]\\
*  EG[a SU [b SU c]]\\
